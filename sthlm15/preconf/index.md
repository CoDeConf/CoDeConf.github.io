...
_Make the most of your trip to Stockholm_{: .inverted} __by taking advantage of the pre-conference _Birds of a Feather_ (BoF) sessions the day before conference. The pre-conference event consists of a series of lightning talks followed by Birds of Feathers discussions. It's designed to provide an in-depth introduction to Continuous Delivery and to allow sufficient time to dive into any depths of details that the participants wants to take. You'll not be in the passenger seat, you'll be driving.__
...
* The day is divided into sessions. Each session is approximately and hour
...
* After BoFs comes coffee or snack break and we'll start over again - three times in total.
